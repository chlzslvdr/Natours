...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYnJ5Y2UyOSIsImEiOiJja3p4cnA4NTIwNGY1MnZwNzJteGd3cWdrIn0.JLvwrEqRYTJ5gH86YUysPw';
  var map = new mapboxgl.Map({
    container: 'map',
    // container ID
    style: 'mapbox://styles/bryce29/ckzxsfw48004814mimmav90v3',
    // style URL
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'GET',
              url: 'http://127.0.0.1:4040/api/v1/users/logout'
            });
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? 'http://127.0.0.1:4040/api/v1/users/updateMyPassword' : 'http://127.0.0.1:4040/api/v1/users/updateMe';
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tourId) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe('pk_test_51KZ99WA3t4pmhijIVw7mBNyPelg4GwMKwmeUed81gIsUs36WU4acTII3K7PJ1cg1dgOwEfeqkpm8IQJ5VQSmAH4100Lx9YZvqh');
            _context.prev = 1;
            _context.next = 4;
            return (0, _axios.default)("http://127.0.0.1:4040/api/v1/bookings/checkout-session/".concat(tourId));
